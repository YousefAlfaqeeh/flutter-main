        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Container(alignment: Alignment.topLeft,
                  padding: EdgeInsets.only(left: 30),
                  child: Text('WELCOME BACK',style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor*22, fontFamily: 'Nunito',fontWeight: FontWeight.bold,color: Colors.white))),
              SizedBox(height:  4.w,),
              Container(alignment: Alignment.topLeft,
                  padding: EdgeInsets.only(left: 30), child: Text('stay up to date with your Sun school ',style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor*14, fontFamily: 'Nunito',fontWeight: FontWeight.normal,color: Colors.white))),
              Container(alignment: Alignment.topLeft,
                  padding: EdgeInsets.only(left: 30),child: Text('Homework’s, announcement',style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor*14, fontFamily: 'Nunito',fontWeight: FontWeight.normal,color: Colors.white))),
              Container(alignment: Alignment.topLeft,
                  padding: EdgeInsets.only(left: 30),child: Text('transportation and more',style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor*14, fontFamily: 'Nunito',fontWeight: FontWeight.normal,color: Colors.white))),
