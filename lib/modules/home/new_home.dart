                          ...
                          Expanded(
                            ...
                            Center(child: CircularProgressIndicator()):Container(
                              ...
                              child: ListView.builder(
                                ...
                                itemCount:list_Notfi_Search.length!=0 && flg?list_Notfi_Search.length:
                                list_Notfi_Search.length!=0 || flg?0:list_notif.length,
...
// color: Colors.blue,
  ...
  Widget design_list(String date,String studentName,String notificationsText ,String image, Color color,String notificationsType,String student_id,String icon, String read, String id,String actionId,Notifications notifications,String studentImage)
  {
    bool vas_drop=true;
  ...
  AppCubit.image=studentImage;
       ...
       else if( notificationsType.toLowerCase().contains("homework"))
       {
         ...
         // Navigator.push(
         //   context,
         //   MaterialPageRoute(builder: (context) => AllWorksheets(std_id:student_id),));
...
crossAxisAlignment: CrossAxisAlignment.start,
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(child: Container(margin: EdgeInsets.only(top: 5),
                                        child: Text(notificationsText, style: TextStyle( fontSize: 16.0,  color: Colors.black,fontWeight: FontWeight.w500),))),
                                  ],
                                )),
                          ),
                          Padding(
  ...
  Widget design_notif(Notifications notifications) {
    ...
    return   design_list(date,studentName,notificationsText ,image, color, notificationsTitle, studentId,iconTracking,notificationsRead,notificationsId,actionId,notifications,studentImage);
  }
