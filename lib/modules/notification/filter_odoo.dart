...
class Filter_odoo extends StatefulWidget {
  const Filter_odoo({Key? key}) : super(key: key);

  @override
  State<Filter_odoo> createState() => _Filter_odooState();
}


class _Filter_odooState extends State<Filter_odoo> {
                                    ...
                                    child: Column(
                                      children: <Widget>[
                                        ...
                                        Container(
                                          height: 30,
                                          child: ListTile(
                                            title:  Text(AppLocalizations.of(context).translate('Decline_r')),
                                            leading: Radio<String>(
                                              value: 'decline',
                                              groupValue: _character,
                                              onChanged: ( value) {
