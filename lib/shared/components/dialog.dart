...
//   Widget title)=>showDialog(context: context, builder: (_)=>dialog(title:title, massage: massage));
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Container(
          height: CacheHelper.getBoolean(key: 'lang').toString().contains('ar')
        ...
        Container(
          ...
          child: Container(
            ...
            child: MaterialButton(
              ...
              onPressed: () {
                if (AppLocalizations.of(context).translate('pic') == massage ||
                    massage.contains(AppLocalizations.of(context)
...
class dialog_send_feed extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Container(
          height: 50, width: 50, alignment: Alignment.topCenter, child: title),
      content: Container(
        padding: const EdgeInsets.all(10),
        child: Text(massage, style: const TextStyle(color: Colors.blue)),
      ),
      actions: [
        Container(
          width: double.infinity,
                          ...
                          onPressed: () async {
                            var responseKids = await DioHelper.postData(
                              ...
                              (value) {
                                ...
                                showDialog(
                                  context: context,
                                  builder: (context) => dialog_send_feed(
                                      massage:
            ...
            children: [
              Row(
                children: [
                  Expanded(
                      child: Text(
                          AppLocalizations.of(context).translate('whole'))),
                  Expanded(
                      child: Radio(
                    value: 'both',
                    groupValue: absent,
              ...
              Row(
                children: [
                  Expanded(
                      child: Text(
                          AppLocalizations.of(context).translate('during'))),
                  Expanded(
                      child: Radio(
                    value: 'pick',
                    groupValue: absent,
                    ...
                    child:
                      ...
                      onPressed: () async {
                        if (absent.toString() != 'null') {
                          ...
                          var isChecked = newDate.day.toString() +
                              '/' +
                ...
                Expanded(
                  child: Container(
                    ...
                    child:
                      ...
                      child: Text(
                        AppLocalizations.of(context).translate('cancel'),
                        style: const TextStyle(color: Colors.blue, fontSize: 12.5),
                      ),
                      onPressed: () => Navigator.pop(context),
                    ),
                    // ),
...
class dialog_confirmed_pick extends StatelessWidget {
  ...
  dialog_confirmed_pick(
      {required this.student_id, required this.title, required this.massage});

  Future<void> confirmed_pick() async {
    var response = await DioHelper.postData(
            url: Perent_Notification,
            data: {
              'name': 'confirmed_pick',
          ...
          widget.image.toString().isNotEmpty
              ? Container(
                  ...
                  child: ClipRRect(
                      ...
                      child: Image(
                          height: 300, image: NetworkImage(widget.image))))
              : Visibility(
                  visible: false,
                  child: Container(),
                ),
...
class _DialogTypeRequestState extends State<DialogTypeRequest> {
  ...
  String type = CacheHelper.getBoolean(key: 'lang').toString().contains('ar')
      ? 'إختيار النوع'
      : 'Select Type';
  String typeReason =  CacheHelper.getBoolean(key: 'lang').toString().contains('ar')?"اختر سبب":'Select Reason';
  bool isAbsence = false;
  bool isLeave = false;
  late DateTime fromDate;
  late DateTime fromTo;
  String textFrom = CacheHelper.getBoolean(key: 'lang').toString().contains('ar')
  ?"اختر التاريخ":'Select date' ;
  String textTo =  CacheHelper.getBoolean(key: 'lang').toString().contains('ar')
      ?"اختر التاريخ":'Select date' ;
  List file1 = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          Padding(
            padding: const EdgeInsets.only(left: 10, top: 20, bottom: 10, right: 5),
            child: Row(
              children: [
                IconButton(
                    onPressed: () {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    border:
                        Border.all(color: const Color(0xff00001f).withOpacity(.2)),
                    ...
                    child: DropdownButton<String>(
                      ...
                      items: <String>[
                        CacheHelper.getBoolean(key: 'lang')
                            ...
                            ? 'إختيار النوع'
                            : 'Select Type',
                        AppLocalizations.of(context).translate('absence_di'),
              ...
              Visibility(
                ...
                child: Container(
                  ...
                  padding: const EdgeInsets.only(left: 20, right: 20),
                  child: Text(
                    AppLocalizations.of(context).translate('Date_From'),
                    style: const TextStyle(
                        fontSize: 16,
                        fontFamily: 'Nunito',
                        fontWeight: FontWeight.bold,
              ...
              Visibility(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        border: Border.all(
                            color: const Color(0xff00001f).withOpacity(.2)),
                        borderRadius: const BorderRadius.all(Radius.circular(5))),
                      ...
                      return InkWell(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(color: const Color(0xffbbc7db))),
                          child: Row(
                            children: [
                              Container(
                                padding: const EdgeInsets.all(15),
                                child: const Image(
                                    image: AssetImage("images/pdf123.png")),
                          ...
                          child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                    ...
                                    style: const TextStyle(color: Color(0xff98aac9))),
                              ]),
                        ),
                      ),
                    ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    border: Border.all(color: const Color(0xff3c92d0), width: 2),
                        ...
                        (value) {
                          ...
                          if (type != 'Late') {
                            showDialog(
                                ...
                                builder: (_) => DialogTypeApsence(
                                    image_name: "images/unnamed.png",
                                    tit: "Absence",
                                    message: "YOUR ABSENCE REQUEST",
                                    messageSubm: 'SUBMITTED',
                                    messageSucc: "SUCCESSFULLY",
                                    std_name: widget.stu_name));
                          } else {
                            showDialog(
                                context: context,
                                barrierDismissible: false,
              ...
              Container(
                ...
                height: 55,
                decoration: BoxDecoration(
                    border: Border.all(color: const Color(0xff3c92d0), width: 2.5),
                    borderRadius: BorderRadius.circular(10)),
                width: double.infinity,
                // color: Colors.orange,
                child: MaterialButton(
                  child: Text(
                    AppLocalizations.of(context).translate('cancel'),
                    style: const TextStyle(color: Color(0xff3c92d0)),
                  ),
                  onPressed: () async {
                    Navigator.push(
                        context,
...
class DialogTypeApsence extends StatefulWidget {
  ...
  DialogTypeApsence(
      ...
      required this.messageSubm,
      required this.messageSucc,
        ...
        Column(
          ...
          children: [
            ...
            Container(
              ...
              width: double.infinity,
              child: Text(
                AppLocalizations.of(context).translate('successfully_sent'),
                style: const TextStyle(
                    fontSize: 20,
            ...
            Container(
              ...
              child: Text(
                AppLocalizations.of(context).translate('has_successfully'),
                style: const TextStyle(
                    fontSize: 15,
                    fontWeight: FontWeight.normal,
                  ...
                  child: Stack(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Image(image: AssetImage('images/badge_da.png')),
                      ),
                      Stack(
                        children: [
                          //  images/bus_genr.png
            ...
            child: Column(
              children: [
                Container(
                    ...
                    child: SvgPicture.asset(
                      "images/back_to_school_pana.svg",
                    )
                      ...
                      children: [
                        ...
                        Text(
                            AppLocalizations.of(context).translate(
                                'The_pickup_request_has_successfully'),
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                          ...
                          child: Text(
                              AppLocalizations.of(context).translate(
                                  'Absent_Notification_sent_successfully'),
                              textAlign: TextAlign.center,
                              style: const TextStyle(
                                  fontSize: 16,
                                  color: Colors.black,
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                          // color: Colors.red,
                          width: 500,
                          child: const Text("Book Notification sent successfully ",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  fontSize: 16,
                                  color: Colors.black,
          ...
          child: Container(
            child: Row(
              ...
              children: [
                Container(
                  child: Text(
                      AppLocalizations.of(context).translate('book_Request'),
                      style: const TextStyle(
                          color: Color(0xff3c92d0),
                          fontSize: 28,
                          fontWeight: FontWeight.bold)),
        ...
        child: Container(
          ...
          child:
            ...
            Container(
              ...
              padding: const EdgeInsets.only(left: 20, right: 20),
              child: Text(
                AppLocalizations.of(context).translate('book_name'),
                style: const TextStyle(
                    fontSize: 16,
                    fontFamily: 'Nunito',
                    fontWeight: FontWeight.bold,
            ...
            Padding(
              ...
              child: DropdownButtonFormField2<dynamic>(
                buttonDecoration: BoxDecoration(
                    color: Colors.white,
                    borderRadius: BorderRadius.circular(8),
                    border: Border.all(width: 1, color: const Color(0xff98aac9))),
                decoration: InputDecoration(
                  isDense: true,
                ...
                hint: Row(
                  children: [
                    Text(
                      AppLocalizations.of(context).translate('select_book'),
            ...
            Container(
              ...
              padding: const EdgeInsets.only(left: 20, right: 20),
              child: Text(
                AppLocalizations.of(context).translate('borrow_period'),
                style: const TextStyle(
                    fontSize: 16,
                    fontFamily: 'Nunito',
                    fontWeight: FontWeight.bold,
            ...
            Row(children: [
              ...
              Container(
                  ...
                  child: Text(
                    AppLocalizations.of(context).translate('soft_copy'),
                    style: const TextStyle(
                        color: Colors.black,
                        fontSize: 16,
                        fontWeight: FontWeight.bold),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        border:
                            Border.all(color: const Color(0xff3c92d0), width: 2.5),
                        borderRadius: BorderRadius.circular(10)),
                    width: double.infinity,
                    // color: Colors.orange,
                    child: MaterialButton(
